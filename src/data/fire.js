...
export default [
  ...
  { name: '干煸鱼片', description: '干香鱼片 麻辣焦酥', price: 38, image: `${base}images/fire/dry_fire_fish.webp` },
  ...
  { name: '鱼香肉丝', description: '鱼香酱浓 三丝脆嫩', price: 18, image: `${base}images/fire/fish_flavor_pork.webp` },
  ...
  { name: '醋溜土豆丝', description: '酸爽脆生 镬气十足', price: 12, image: `${base}images/fire/potato_slices.webp` },
  ...
  { name: '手撕包菜', description: '铁锅炝炒 猪油沁脆', price: 12, image: `${base}images/fire/tear_cabbage.webp` },
