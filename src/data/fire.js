...
export default [
  ...
  { name: '小炒黄牛肉', description: '猛火快炒 鲜嫩湘辣', price: 38, image: `${base}images/fire/fire_yellow_beef.webp` },
  { name: '鱼香茄子', description: '鱼香酱浓 软糯回甜', price: 18, image: `${base}images/fire/fish_flavor_eggplant.webp` },
  { name: '地三鲜', description: '东北土法 酱烧三宝', price: 18, image: `${base}images/fire/ground_three_yummy.webp` },
  { name: '宫保鸡丁', description: '川味糊辣 荔枝回甜', price: 28, image: `${base}images/fire/palace_protect_chicken.webp` }, 
  { name: '铁板牛柳', description: '铁板炙烤 黑椒嫩牛', price: 38, image: `${base}images/fire/pepper_beef.webp` },
  { name: '回锅肉', description: '肥瘦相间 豆瓣酱香', price: 38, image: `${base}images/fire/re_pot_pork.webp` },
  { name: '葱爆羊肉', description: '葱香爆炒 羊肉鲜嫩', price: 38, image: `${base}images/fire/scallion_mutton.webp` },
