...
export default [
  ...
  { name: '徐州肉酱米线', description: '秘制肉酱 汤底醇厚', price: 12, image: `${base}images/main_food/meat_rice_noodles.webp` },
  ...
  { name: '酸辣粉', description: '手工红薯粉 老坛酸香', price: 10, image: `${base}images/main_food/sour_spicy_rice_noodles.webp` },
  { name: '榨菜肉丝面', description: '独家榨菜 现炒浇头', price: 10, image: `${base}images/main_food/tuber_meat_noodles.webp` },
