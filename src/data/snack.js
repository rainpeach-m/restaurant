...
export default [
  ...
  { name: '桥头排骨', description: '桥头秘方 骨酥蒜浪', price: 20, image: `${base}images/snack/bridge_head_rib.webp` }, 
  ...
  { name: '烤鸡腿', description: '焦糖脆皮 肉汁暗涌', price: 10, image: `${base}images/snack/chicken_leg.webp` },
  ...
  { name: '青梅绿茶', description: '梅酸解腻 茶香回甘', price: 8, image: `${base}images/snack/z_green_plum.webp` }, 
  { name: '冰红茶', description: '琥珀透光 冰舌生津', price: 6, image: `${base}images/snack/z_ice_red_tea.webp` },
  ...
  { name: '金桔柠檬', description: '现捣果粒 酸爽醒神', price: 10, image: `${base}images/snack/z_orange_lemon.webp` },
  { name: '冰镇桃汁', description: '冰晶沁爽 蜜桃甜吻', price: 8, image: `${base}images/snack/z_peach_juice.webp` },
  { name: '酸梅汤', description: '古法熬制 乌梅烟熏', price: 8, image: `${base}images/snack/z_sour_plum.webp` }, 
